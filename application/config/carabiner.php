...
$config['script_dir'] = 'assets/front/js/';
...
$config['style_dir'] = 'assets/front/css/';
...
$config['dev'] = TRUE; // (ENVIRONMENT == 'development') ? TRUE : FALSE;
...
$config['minify_js'] =  (ENVIRONMENT == 'development') ? FALSE : TRUE;
...
$config['minify_css'] = (ENVIRONMENT == 'development') ? FALSE : TRUE;
